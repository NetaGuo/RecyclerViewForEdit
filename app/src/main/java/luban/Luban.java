...
import static luban.Preconditions.checkNotNull;
...
public class Luban {
    ...
    private File thirdCompress(@NonNull File file) {
        ...
        final String string = imagePath.substring(index+1,imagePath.length());

        String thumb = mCacheDir.getAbsolutePath() + "/" + string;
